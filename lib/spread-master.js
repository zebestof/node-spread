	...
	Master.prototype = {
		...
		_sendToWorkers: function (messages, callback) {
			...
			if (this.skipped < this.skip) {
				...
				if (this.skipped + messages.length < this.skip) {
					this.skipped += messages.length
					return callback();
				} else {
					var rest = (this.skip - this.skipped);

					messages.splice(0, rest);
					this.skipped += rest;
				}
			...
			for (var i = 0; i < this.workerCount && i < this.pendingResults; i++) {
